...
const Answer = ({ answer }) => {
  ...
  return (
    <NavLink
      to={`/question/${answer.answerFor.title.replace(/[?\/]/g, "")}/${
        answer.answerFor._id
      }`}
    ...
    >
      ...
      >
        ...
        >
          <p style={{ textDecoration: "none", color: "#a6a6a6" }}>{desc}</p>
          <p
            style={{
              display: "flex",
              alignItems: "center",
          ...
          >
            ...
            <img
              ...
              alt="thumb-up"
            />{" "}
            • {moment(new Date(answer.answeredOn)).fromNow()}
          </p>
        </div>
      </div>
    </NavLink>
